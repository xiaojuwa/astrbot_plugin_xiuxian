...
class MiscHandler:
    ...
    async def handle_help(self, event: AstrMessageEvent):
        help_text = (
            ...
            f"  {CMD_SECT_SHOP} - 查看宗门商店\n"
            f"  {CMD_SECT_EXCHANGE} <物品> [数量] - 兑换物品\n"
            f"  {CMD_SECT_BUILDINGS} - 查看宗门建筑\n"
            f"  {CMD_BUILD} <建筑名> - 建造建筑(宗主)\n"
            f"  {CMD_UPGRADE_BUILDING} <建筑名> - 升级建筑\n"
            f"  {CMD_ACTIVATE_BUILDING} <建筑名> - 激活Buff\n"
            "\n"
            "【战斗探险】\n"
            f"  {CMD_SPAR} @某人 - 切磋比试\n"
